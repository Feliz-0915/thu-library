...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p :class="{ 'highlight-orwell': orwell?.name === 'George Orwell' }">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(time, dayType) in bookstores.openingHours" :key="dayType">
          {{ dayType }}: {{ time.open }} - {{ time.close }}
        </li>
      </ul>
